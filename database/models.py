...
class User(models.Model):
    first_name = models.CharField(null=False, max_length=30, default='Duy')
    last_name = models.CharField(null=False, max_length=30, default='Pham')
...
class Instructor(User):
    ...
    # Create a toString method for object string representation
    def __str__(self):
        return 'First name: {}, Last name: {}, Is full time: {}, Total Learners: {}'.format(
            self.first_name, self.last_name, str(self.full_time), str(self.total_learners)
        )
...
class Learner(User):
    ...
    # Create a toString method for object string representation
    def __str__(self):
        return 'First name: {}, Last name: {}, Date of Birth: {}, Occupation: {}, Social Link: {}'.format(
            self.first_name, self.last_name, str(self.dob), self.occupation, self.social_link
        )
